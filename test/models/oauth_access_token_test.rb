...
class OauthAccessTokenTest < ActiveSupport::TestCase
  ...
  test "auto-generates token with mcpa_oauth_ prefix and 1 year expiry" do
    t = OauthAccessToken.create!(user: @user, oauth_client: @client, scope: "read:analytics")
  ...
  test "active? false after revoke or expiry" do
    ...
    t2 = OauthAccessToken.create!(user: @user, oauth_client: @client, scope: "read:analytics", expires_at: 1.minute.ago)
