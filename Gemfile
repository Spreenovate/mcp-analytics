...
# Lightweight ClickHouse HTTP client written in-house (lib/click_house.rb).
...
# Markdown renderer for /blog and /vs content. kramdown is pure-Ruby
# (no native deps), GFM parser adds fenced code blocks + tables.
gem "kramdown"
